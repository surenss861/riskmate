-- Template filters (template_source, template_id) for jobs list and search.
-- Applied server-side so pagination and totals are correct.

-- get_jobs_list: add p_template_source ('template'|'manual'|null), p_template_id (uuid|null)
DROP FUNCTION IF EXISTS get_jobs_list(uuid, integer, integer, boolean, text, text, text, uuid, real, real, text, text, uuid[], uuid[], boolean, boolean, integer, boolean, boolean, boolean);
...
-- get_jobs_ranked: add p_template_source, p_template_id
