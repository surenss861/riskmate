-- Ensure org owner/admin can update comments for resolve/unresolve and soft-delete.
...
-- Author-only UPDATE policy remains for content edits. This policy unblocks admin/owner resolve/delete paths.
