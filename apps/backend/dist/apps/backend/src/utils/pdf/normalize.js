...
exports.normalizeControlStatus = normalizeControlStatus;
exports.normalizeAttestationStatus = normalizeAttestationStatus;
exports.isControlOverdue = isControlOverdue;
...
exports.assertNoBadChars = assertNoBadChars;
exports.sanitizeText = sanitizeText;
exports.safeTextForPdf = safeTextForPdf;
exports.sortControls = sortControls;
exports.sortAttestations = sortAttestations;
exports.calculateControlKPIs = calculateControlKPIs;
exports.calculateAttestationKPIs = calculateAttestationKPIs;
exports.countActiveFilters = countActiveFilters;
exports.formatFilterContext = formatFilterContext;
// ============================================================================
...
function normalizeAttestationStatus(status) {
    const normalized = (status || '').toLowerCase().trim();
...
// OVERDUE LOGIC
// ============================================================================
function isControlOverdue(status, dueDate) {
 ...
 */
function assertNoBadChars(text, context) {
 ...
 */
function safeTextForPdf(text, context) {
...
// KPI CALCULATION
// ============================================================================
function calculateControlKPIs(controls) {
    let completed = 0;
    let pending = 0;
    let overdue = 0;
    let highSeverity = 0;
...
function calculateAttestationKPIs(attestations) {
    let completed = 0;
    let pending = 0;
