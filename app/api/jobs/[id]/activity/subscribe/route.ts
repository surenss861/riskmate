...
/** Channel ID for Realtime subscription to audit_logs where (target_type=job AND target_id=jobId) or metadata->>job_id=jobId or job_id=jobId. Must match lib/realtime/eventSubscription.ts */
