...
const ROUTE = '/api/jobs/[id]/comments'

const ENTITY_TYPE = 'job'

/** GET /api/jobs/[id]/comments — list comments for a job (author info, reply counts). Excludes soft-deleted by default. */
...
/** POST /api/jobs/[id]/comments — create a comment (with mention parsing and notifications). */
